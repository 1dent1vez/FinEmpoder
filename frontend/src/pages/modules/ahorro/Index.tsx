  ...
  return (
    <Box sx={{ p: 2, pb: 9 }}>
      <Stack direction="row" alignItems="center" spacing={1}>
        <SavingsIcon sx={{ color: ORANGE }} />
        <Typography variant="h6" fontWeight={800}>
          Plan rapido de ahorro
        </Typography>
      </Stack>

      <Paper sx={{ p: 2, borderRadius: 3, mt: 2, borderLeft: `6px solid ${ORANGE}` }}>
      ...
      <Paper sx={{ p: 2, borderRadius: 3, mt: 2, borderLeft: `6px solid ${BLUE}` }}>
        <Stack direction="row" alignItems="center" spacing={1}>
        ...
        <Stack spacing={1.25} sx={{ mt: 1 }}>
          ...
          <LinearProgress
            ...
            sx={{
              ...
              borderRadius: 5,
              bgcolor: '#f0f0f0',
              '& .MuiLinearProgress-bar': { bgcolor: paceOk ? '#2ECC71' : ORANGE }
            }}
          />
          <Typography variant="body2" color="text.secondary">
      ...
      <Paper sx={{ p: 2, borderRadius: 3, mt: 2 }}>
        <Stack direction="row" alignItems="center" spacing={1}>
          <AutoAwesomeIcon sx={{ color: '#8E44AD' }} />
        ...
        <Stack spacing={1}>
          ...
          <Button
            ...
            sx={{ alignSelf: 'flex-start', bgcolor: ORANGE, '&:hover': { bgcolor: '#e48c1a' } }}
          >
            Ver lecciones
          </Button>
